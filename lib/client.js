...
body.dsh-skin-galactic-opera.dsh-skin-input-active :is(.dsh-skin-nebula-core, .dsh-skin-energy, .dsh-skin-comet, .dsh-skin-starfighter, .dsh-skin-mission-crawl, .dsh-skin-scanner, .dsh-skin-scanner::after, .dsh-skin-route-map, .dsh-skin-satellite, .dsh-skin-satellite-orbit, .dsh-skin-satellite-orbit-front) {
  animation-play-state: paused !important;
}
