...
body.dsh-skin-galactic-opera .dsh-skin-telemetry-panel {
  position: fixed !important;
  right: max(18px, 2.4vmin) !important;
  bottom: max(18px, 2.4vmin) !important;
  left: auto !important;
  top: auto !important;
  ...
  max-width: min(178px, 28vw) !important;
  min-width: 132px !important;
  max-height: 32vh !important;
  min-height: 42px !important;
  overflow: hidden !important;
  padding: 18px 12px 12px !important;
  border: 1px solid rgba(125,227,255,0.48) !important;
  border-left-color: rgba(255,207,92,0.62) !important;
  border-bottom-color: rgba(255,71,120,0.36) !important;
  ...
  background:
    ...
    linear-gradient(180deg, rgba(6,10,26,0.92), rgba(10,17,42,0.84)) !important;
  box-shadow:
    inset 0 0 0 1px rgba(255,255,255,0.07),
    inset 0 0 24px rgba(125,227,255,0.09),
    0 0 28px rgba(125,227,255,0.22),
    0 0 52px rgba(255,71,120,0.10) !important;
  ...
  text-shadow: 0 0 10px rgba(125,227,255,0.30) !important;
}
...
body.dsh-skin-galactic-opera .dsh-skin-telemetry-panel :is(span, div, p) {
  display: block !important;
  max-width: 100% !important;
}
...
`;
		...
		function installTelemetryPanel() {
			...
			const skipSelector = `#${DECOR_ID}, style, script, textarea, input, select, [contenteditable=true], .dsh-skin-pulse`;
			...
			const update = () => {
				...
				current?.classList.remove("dsh-skin-telemetry-panel");
				current?.removeAttribute("data-dsh-skin-telemetry");
				current = next;
				current?.classList.add("dsh-skin-telemetry-panel");
				current?.setAttribute("data-dsh-skin-telemetry", "true");
			};
			const schedule = () => {
