...
body.dsh-skin-galactic-opera .dsh-skin-nebula-core::after {
  ...
  opacity: 0;
  background:
    radial-gradient(circle at 50% 12%, rgba(255,255,255,0.86) 0 1px, transparent 1.8px),
    radial-gradient(circle at 82% 42%, rgba(125,227,255,0.72) 0 1.2px, transparent 2px),
    radial-gradient(circle at 67% 78%, rgba(255,207,92,0.66) 0 1px, transparent 1.8px),
    radial-gradient(circle at 22% 65%, rgba(255,71,120,0.54) 0 1.2px, transparent 2px),
    radial-gradient(circle at 31% 25%, rgba(125,227,255,0.58) 0 1px, transparent 1.8px);
  -webkit-mask-image: radial-gradient(circle, transparent 0 15%, #000 22% 74%, transparent 86%);
  mask-image: radial-gradient(circle, transparent 0 15%, #000 22% 74%, transparent 86%);
  filter: blur(0.15px) drop-shadow(0 0 8px rgba(125,227,255,0.34));
  animation: dsh-skin-blackhole-infall 5.8s cubic-bezier(.42,0,.18,1) infinite;
}
...
@keyframes dsh-skin-blackhole-infall {
  0% { opacity: 0; transform: rotate(-18deg) scale(1.28); }
  18% { opacity: 0.34; }
  62% { opacity: 0.18; transform: rotate(28deg) scale(0.78); }
  100% { opacity: 0; transform: rotate(42deg) scale(0.52); }
}
